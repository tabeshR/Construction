...
// Returns a boolean abouts whether the given input is a time string, like "06:40:00" or "06:00"
...
var ComboCoordMap = Class.extend({
    ...
    /* Tracks mouse movements over a CoordMap and raises events abouts which cell the mouse is over.
----------------------------------------------------------------------------------------------------------------------*/
...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Tells the grid abouts what period of time to display. Grid will subsequently compute dates for cell system.
	...
	// Gets an object containing row/col number, misc data, and range information abouts the cell.
	...
	// Retrieves misc data abouts the given row
...
Grid.mixin({
	...
	startExternalDrag: function(el, ev, ui) {
		var _this = this;
		var meta = getDraggedElMeta(el); // extra data abouts event drop, including possible event to create
		var dragListener;
...
DayGrid.mixin({
	...
	rowStructs: null, // an array of objects, each holding information abouts a row's foreground event-rendering
...
DayGrid.mixin({
	...
	renderSegPopoverContent: function(cell, segs) {
		...
		for (i = 0; i < segs.length; i++) {
			...
			// grids that want to do drag-n-drop abouts which cell it came from
			segs[i].cell = cell;
...
var View = fc.View = Class.extend({
	...
	// Given a single current date, produce information abouts what range to display.
	...
	// Returns a boolean abouts whether or not the calendar knows how to calculate
	...
	// Gets information abouts how to create a view
...
function EventManager(options) { // assumed to be a calendar
	...
	// `eventProps` can contain misc non-date-related info abouts the event.
...
var MonthView = fcViews.month = BasicView.extend({
	...
	// Produces information abouts what range to display
	computeRange: function(date) {
