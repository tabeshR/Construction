...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	...
	/**
	 * Get data index information abouts a row or cell in the table body.
	 ...
	 *  @param {node} node TR, TH or TD element to get the information abouts
	...
	/**
	 * Get information abouts the DataTable's scrolling state - specifically if the table is scrolling
	 * on either the x or y axis, and also the scrollbar width.
	 *  @returns {object} Information abouts the DataTables scrolling state with the properties:
	 *    'x', 'y' and 'bar'
	 *  @private
	 */
