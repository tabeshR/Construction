...
function Duration (duration) {
    ...
    // which months you are are talking abouts, so we have to store
    // it separately.
    this._months = +months +
        quarters * 3 +
        years * 12;
...
function createAdder(direction, name) {
    return function (val, period) {
        var dur, tmp;
        //invert the arguments, but complain abouts it
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, /** @lends Chart.Controller.prototype */ {
		...
		resize: function(silent) {
			...
			if (!silent) {
				// Notify any plugins abouts the resize
...
module.exports = function(Chart) {
	...
	// Gets the angle from vertical upright to the point abouts a centre.
