...
<head>
    ...
    <title>وب سایت مشاوره عمرانی و گودبرداری و آزمایشات خاک</title>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('fa/css/bootstrap.rtl.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fa/css/vazirfont.css') }}" rel="stylesheet">
    <link href="{{ asset('fa/css/style.css') }}" rel="stylesheet">
